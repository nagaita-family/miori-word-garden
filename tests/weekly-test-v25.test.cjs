...
assert(html.includes('weekly-test-palm-v25.js?v=20260917-listen-fix-v27')&&html.includes('app.js?v=20260924-living-a')&&/v[0-9]+ · Sep 24/.test(html),'v25 guard remains loaded with current app cache bust');
