...
assert(page.includes('weekly-test-v24.css?v=20260917-v24')&&page.includes('app.js?v=20260923-trace-ink-v37')&&/v[0-9]+ · Sep 23/.test(page),'v24 assets have cache busting and a visible version');
