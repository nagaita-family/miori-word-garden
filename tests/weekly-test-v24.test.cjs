...
assert(page.includes('weekly-test-v24.css?v=20260917-v24')&&page.includes('app.js?v=20260917-backup-controls-v33')&&/v[0-9]+ · Sep 17/.test(page),'v24 assets have cache busting and a visible version');
