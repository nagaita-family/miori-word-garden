...
assert(page.includes('weekly-test-v24.css?v=20260917-v24')&&page.includes('app.js?v=20260924-living-c6')&&/v[0-9]+ · Sep 25/.test(page),'v24 assets have cache busting and a visible version');
