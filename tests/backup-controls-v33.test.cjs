...
(async()=>{
  ...
  assert(html.includes('backup-controls-v33.css?v=20260917-v33')&&html.includes('app.js?v=20260923-trace-ink-v37'),'New assets are cache-busted');
  assert(html.includes('v37 · Sep 23'),'Parent changes show their version');
