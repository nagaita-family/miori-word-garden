...
(async()=>{
  ...
  assert(html.includes('backup-controls-v33.css?v=20260917-v33')&&html.includes('app.js?v=20260924-living-a'),'New assets are cache-busted');
  assert(html.includes('v39 · Sep 24'),'Parent changes show their version');
