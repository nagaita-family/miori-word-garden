...
(async()=>{
  ...
  assert(html.includes('backup-controls-v33.css?v=20260917-v33')&&html.includes('app.js?v=20260917-backup-controls-v33'),'New assets are cache-busted');
  assert(html.includes('v33 · Sep 17'),'Parent changes show their version');
