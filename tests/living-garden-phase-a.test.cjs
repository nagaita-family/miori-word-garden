...
test('environment is naturally bounded, lightweight and honors reduced motion',()=>{
 ...
 assert(page.includes('living-garden.js?v=20260924-placement'));
 assert(page.indexOf('living-garden.js?v=20260924-placement')<page.indexOf('app.js?v=20260924-living-c6'));
});
