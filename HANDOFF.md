...
**Validation:** Targeted C.6/D.2/D.4/placement tests 15/15, including a character release just outside an item and tap placement over an overlapping item. Syntax and whitespace checks passed. Full regression, production browser interaction and GitHub Pages details follow after publication. Physical iPad/Pencil still needs device QA. The local checkout is still behind remote main and contains published work as uncommitted changes; preserve it.
