...
Verification in progress: targeted Phase A/B/C and Play/Weekly tests, visual browser inspection after publication, and Pages status. Actual iPad Safari/Pencil performance and touch behavior must still be checked on a device.
